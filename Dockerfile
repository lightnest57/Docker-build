...
RUN apt-get -yqq update \    
     && apt-get install -yqq --no-install-recommends sudo ssh git ffmpeg openjdk-8-jdk openjdk-8-jre maven nodejs ca-certificates-java python-is-python3 pigz tar rsync rclone aria2 libncurses5 \
